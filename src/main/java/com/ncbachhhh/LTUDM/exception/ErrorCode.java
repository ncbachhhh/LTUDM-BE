...
public enum ErrorCode {
    ...
    INVALID_PASSWORD_FORMAT(400, "Password must be at least 8 characters and contain uppercase, lowercase, number, and special character"),
    ...
    BACKGROUND_FILE_REQUIRED(400, "Background image file is required"),
    INVALID_BACKGROUND_FILE_TYPE(400, "Background image must be JPG, PNG, GIF, or WEBP"),
    BACKGROUND_FILE_TOO_LARGE(400, "Background image must not exceed 5MB"),
    BACKGROUND_UPLOAD_FAILED(500, "Background image upload failed"),
    INVALID_GENDER_FORMAT(400, "Gender must not exceed 20 characters"),
    INVALID_DOB(400, "Date of birth must not be in the future"),
    ...
    INVALID_NOTIFICATION_SOUND(400, "Notification sound is invalid"),
    ...
    CANNOT_REMOVE_GROUP_OWNER(400, "Transfer ownership before removing the group owner"),
    CANNOT_REMOVE_SELF_FROM_GROUP(400, "Use leave group to remove yourself"),
    CANNOT_TRANSFER_OWNERSHIP_TO_SELF(400, "New group owner must be another member"),
    CONVERSATION_AVATAR_FILE_REQUIRED(400, "Group avatar file is required"),
    INVALID_CONVERSATION_AVATAR_FILE_TYPE(400, "Group avatar must be JPG, PNG, GIF, or WEBP"),
    CONVERSATION_AVATAR_FILE_TOO_LARGE(400, "Group avatar must not exceed 5MB"),
    CONVERSATION_AVATAR_UPLOAD_FAILED(500, "Group avatar upload failed"),
    ...
    CANNOT_RECALL_OTHERS_MESSAGE(403, "Only the sender can recall this message"),
    CANNOT_REPLY_RECALLED_MESSAGE(400, "Cannot reply to a recalled message"),
